...
{
    public class ProductManagementController(AccountDAO accountDAO, ProductDAO productDAO) : Controller
    {
        [HttpGet]
        public async Task<IActionResult> Index(int CurrentPage)
        {
            ...
            return View("~/Views/Dashboard_Shop/ProductManagement/Index.cshtml",listProduct);
        }
        [HttpGet]
        public async Task<IActionResult> Add()
        {
            ...
            return View("~/Views/Dashboard_Shop/ProductManagement/Add.cshtml");
        }
        ...
        public async Task<IActionResult> Update(int Id)
        {
            ...
            return View("~/Views/Dashboard_Shop/ProductManagement/Update.cshtml", product);
        }
